<div id="products" class="col-sm-12 col-md-9 pull-right h2-indent">
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <ul class="prod-box min-sm">
        <li>
          <h3><a href="<?php echo get_term_link('dc-motor') ?>">DC MOTOR</a> <span>[Permanent Magnet]</span></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('ac-motor') ?>">AC MOTOR</a> <span>[Induction]</span></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('brushless-dc-motor') ?>">BRUSHLESS DC MOTOR</a></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('universal-motor') ?>">UNIVERSAL MOTOR</a></h3>
        </li>
        <li>
          <div>
    ...
    <div class="col-sm-6">
      ...
      <ul class="prod-box min-sm">
        <li>
          <h3><a href="<?php echo get_term_link('dc-gear-motor') ?>">DC GEAR MOTOR</a></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('ac-gear-motor') ?>">AC GEAR MOTOR</a></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('brushless-gear-motor') ?>">BRUSHLESS GEAR MOTOR</a></h3>
        </li>
        <li>
          <div>
        ...
        <li>
          <h3><a href="<?php echo get_term_link('gearbox-reducer') ?>">GEARBOX REDUCER</a></h3>
        </li>
        <li>
          <div>
  ...
  <ul class="prod-box double indented-links">
    <li>
      ...
      <div>
        <h3><a href="<?php echo get_term_link('ac') ?>">AC Motor Speed Control</a></h3>
    ...
    <li>
      ...
      <div>
        <h3><a href="<?php echo get_term_link('brushless') ?>">Brushless Speed Control</a></h3>
