		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div class="clearfix">
				<form id="narrow-search" class="large">
					<div class="one">
						Motor Type
						<button type="button" value="all" class="motor-select motor-select-all">All motors</button>
						<button type="button" value="dc" class="motor-select selected">DC</button>
					...
					<div class="two">
						...
						<div class="two-col">
							...
							<div>
								<button type="button" value="163" class="motor-select-voltage voltage-163" disabled>163/115</button>
							</div>
						</div>
						<div class="two-col">
							<div>
						...
						<div class="two-col">
							...
							<div>
								<button type="button" value="230" class="motor-select-voltage voltage-230" disabled>230</button>
							</div>
						</div>
						<br>
						Phase
						<button type="button" value="all" class="motor-select-phase motor-select-phase-all" disabled>All phases</button>
						<button type="button" value="1ph 60Hz" class="motor-select-phase 160-phase" disabled>1 ph 60 Hz</button>
						<button type="button" value="1ph 50Hz" class="motor-select-phase 150-phase" disabled>1 ph 50 Hz</button>
						<button type="button" value="3ph 60Hz" class="motor-select-phase 360-phase" disabled>3 ph 60 Hz</button>
						<button type="button" value="3ph 50Hz" class="motor-select-phase 350-phase" disabled>3 ph 50 Hz</button>
						<button type="button" value="dc" class="motor-select-phase motor-select-phase-dc selected">DC</button>
					</div>
