<?php if($_POST && count($_POST) > 1): ?>
    <?php $products = motor_match($_POST); ?>
<?php endif; ?>
<?php unset($_SERVER['QUERY_STRING']); ?>

<form class="form_wrapper" method="post" action="<?php echo get_permalink() ?>">
					<div>
        ...
        <ul>
            ...
            <label>Speed</label>
            <div class="left">
            	<input type="text" name="speed" class="performance_stp" id="speed_stp" value="<?php echo (isset($products['data']['ispeed']))? $products['data']['ispeed'] : "" ; ?>" <?php echo ($disabled == "speed")? "disabled" : ""; ?> />
            </div>
            <div class="right">
            	rpm
            </div>
            <?php /* <div class="tooltip"><div class="icon">?</div><div class="tip" id="tip-speed">Number of full shaft revolutions per minute.</div></div> */ ?>
        </li>
        <li>
            <label>Torque</label>
            <div class="left">
            ...
            <?php /* <div class="tooltip"><div class="icon">?</div><div class="tip" id="tip-torque">The amount of force necessary to rotate an object around an axis.</div></div> */ ?>
        </li>
        <li>
            <label>Power</label>
            <div class="left">
            ...
            <?php /* <div class="tooltip"><div class="icon">?</div><div class="tip" id="tip-power">The rate at which work is being done, related to force, distance and time.</div></div> */ ?>
        </li>
    </ul>
