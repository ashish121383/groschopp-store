        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ul class="prod-box min-sm">
                    ...
                    <li>
                        <h3><a href="<?php echo $term ?>">DC MOTOR</a> <span>[Permanent Magnet]</span></h3>
                    </li>
                    <li>
                        <div>
                            <img src="<?php echo get_field('dc_motor_image',get_option( 'woocommerce_shop_page_id' )) ?>" alt=""> <!-- made image size called 'product-overview' (200x200) -->
                        </div>
                        <div>
						    <?php $dc_pages = get_field("dc_sub_pages", get_option( 'woocommerce_shop_page_id' )) ?>
                            <?php if(count($dc_pages)): ?>
                    ...
                    <li>
                        <div>
                            <img src="<?php echo get_field('field_57f33ba1381fc', get_option( 'woocommerce_shop_page_id' )) ?>" alt=""> <!-- made image size called 'product-overview' (200x200) -->
                        </div>
                        <div>
						    <?php $ac_pages = get_field("field_57f33bc0381fd", get_option( 'woocommerce_shop_page_id' )) ?>
                            <?php if(count($ac_pages) > 1): ?>
                    ...
                    <li>
                        <div>
                            <img src="<?php echo get_field('field_586402dbb2b87', get_option( 'woocommerce_shop_page_id' )) ?>" alt=""> <!-- made image size called 'product-overview' (200x200) -->
                        </div>
                        <div>
						    <?php $brushless_dc_pages = get_field("field_58640301b2b89", get_option( 'woocommerce_shop_page_id' )) ?>
                            <?php if(count($brushless_dc_pages) > 1): ?>
                    ...
                    <!--
                        <div>
                            <img src="<?php echo get_field('field_586402f5b2b88', get_option( 'woocommerce_shop_page_id' )) ?>" alt=""> 
                        </div>
                        <div>
                            <?php /*
                            ...
                            */ ?>
                            ...
                            <a href="<?php echo get_permalink(4340) ?>">Universal Motor Part Sets</a>
                            <a href="<?php echo get_permalink(8337) ?>">Open Frame Universal Motor</a>
                        </div>
                    </li>
                -->
                </ul>
                ...
                <ul class="prod-box min-lg indented-links" style="min-height: 237px;">
