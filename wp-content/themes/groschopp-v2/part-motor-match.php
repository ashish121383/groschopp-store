            ...
            <?php $alt = false; ?>
                <?php foreach($products['results'] as $product): ?>
                    ...
                    <tr>
                        ...
                        <td class="<?php echo $alt ?>"><a href="<?php echo $product_url->field('search_slug') ?>?id=<?php echo $product->id ?>&hash=<?php echo $products['data']['search_hash'] ?>"><?php echo $product->ordering_number ?></a></td>
...
<p>&nbsp</p>
<strong><hr /></strong>
<h1 style="color:#2685c4">More Motor Search Help</h1>
<p>Need more help finding a motor that matches your application? This tool represents only a portion of our available motor designs. Give us a call at 800-829-4135 to talk about all options. Visit our Motor Search <a href="<?php echo get_permalink(1055) ?>">help page</a> for instructions about how to use this tool, or feel free to <a href="<?php echo get_permalink(11) ?>">contact us</a> via our online form. We're here to help!</p>
