...
function get_meta($field, $post_id = null) 
{ 
	global $post; 
...
add_action( 'after_setup_theme', 'arcstone_setup' );

if (!function_exists( 'arcstone_setup' )) {

	function arcstone_setup() {

		register_nav_menu( 'primary', __('Primary Menu', 'arcstone'));
		register_nav_menu( 'secondary', __('Secondary Menu', 'arcstone'));
	}
}
