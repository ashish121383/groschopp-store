			...
			<div id="selected-prods">
				...
				<ul>
					...
					<li>
						...
						<span class="num">Prod# <?php echo $product->ordering_number ?></span> | <span class="model">Model: <?php echo $product->model ?><input type="hidden" name="product[]" value="<?php echo $v ?>" /></span><span class="remove"><a href="<?php bloginfo('template_url'); ?>/quote-remove.php?product=<?php echo $k ?>">Remove</a></span>
				...
				Return to our <a href="<?php echo get_permalink(4873) ?>">products page</a><br/> to continue shopping.
