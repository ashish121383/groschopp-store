	...
	<div class="col-md-9 pull-right">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<a href="<?php bloginfo('template_url'); ?>/quote-add.php?gearbox=<?php echo get_the_title() ?> Frame <?php echo get_the_title($post->post_parent) ?>" class="btn btn-primary btn-alternate btn-block btn-lg quote-add">Add To Quote</a>		
			</div>
