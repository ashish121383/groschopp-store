			...
			<li class="control-list-item">
				<a href="<?php the_permalink() ?>">
					...
					<div class="control-list-content row">
						...
						<div>
							<table class="control-spec-table">
								<colgroup>
									<col width="86">
									<col width="51">
									<col width="80">
	...
	<div id="ac-controls" class="col-md-9 pull-right">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<a href="<?php bloginfo('template_url'); ?>/quote-add.php?control=<?php echo get_the_title() ?>" class="btn btn-primary btn-alternate btn-block btn-lg quote-add">Add To Quote</a>		
			</div>
