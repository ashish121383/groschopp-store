		...
		<div class="row">
			<div class="col-md-4">
				...
				*/ ?>	
				...
				<a href="<?php bloginfo('template_url'); ?>/quote-add.php?accessory=<?php echo get_the_title() ?>" class="btn btn-primary btn-alternate btn-block btn-lg quote-add">Add To Quote</a>		
			</div>
